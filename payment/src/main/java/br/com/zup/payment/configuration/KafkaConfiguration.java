...
public class KafkaConfiguration {
  ...
  public NewTopic message() {
    return new NewTopic("payment-callback", 1, (short) 1);
  }
  ...
  @Bean
  public KafkaTemplate<String, PaymentCallbackEvent> messageKafkaTemplate() {
    return new KafkaTemplate<String, PaymentCallbackEvent>(messageProducerFactory());
  }
