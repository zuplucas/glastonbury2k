...
public class PaymentTask implements JavaDelegate {
	...
	public void execute(DelegateExecution delegateExecution) throws Exception {
		...
		case TASK_PAYMENT:
			this.paymentApi.paymenting(bookRequest);
			break;
		default:
			break;
		}
