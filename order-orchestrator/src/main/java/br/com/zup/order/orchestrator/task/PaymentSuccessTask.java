...
@Component
public class PaymentSuccessTask implements JavaDelegate{

    private OrderApi orderApi;
    private ObjectMapper objectMapper;
    private String PAYMENT_FAILURE = "Order Payment Success";

    public PaymentSuccessTask(OrderApi orderApi, ObjectMapper objectMapper) {
