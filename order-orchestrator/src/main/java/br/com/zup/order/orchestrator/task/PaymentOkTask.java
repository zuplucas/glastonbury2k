...
@Component
public class PaymentOkTask implements JavaDelegate {
    ...
    @Autowired
    public PaymentOkTask(StatusOrderApi statusOrderApi, ObjectMapper objectMapper) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        statusOrderRequest.setStatus("payment ok!");
