...
@Component
public class NoStockTask implements JavaDelegate {
    ...
    @Autowired
    public NoStockTask(StatusOrderApi statusOrderApi, ObjectMapper objectMapper) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        statusOrderRequest.setStatus("no stock!");
