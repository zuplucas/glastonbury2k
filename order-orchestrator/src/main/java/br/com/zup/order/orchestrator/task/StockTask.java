...
@Component
public class StockTask implements JavaDelegate {
    ...
    @Autowired
    public StockTask(StatusOrderApi statusOrderApi, ObjectMapper objectMapper) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        statusOrderRequest.setStatus("stock ok!");
